    ...
    <html>
      ...
      <body>
        <div className="preview">
          <header>
            <img src="../examples/logo.png" height="100px"/>
            <h3 className="company">{sender.company}</h3>
            <div className="sender">
              <div className="name">{sender.name}</div>
              <div className="company">{sender.company}</div>
              <div className="address">{sender.building}</div>
              <div className="address">{sender.address}</div>
              <div className="district">{sender.postalCode} {sender.district}</div>
              ...
              <div className="account">{sender.bank} Account No: {sender.account}</div>
            </div>
            <div className="extra">
